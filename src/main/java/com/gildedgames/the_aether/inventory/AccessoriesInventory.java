...
public class AccessoriesInventory implements IAccessoryInventory {
	...
	public float getCurrentPlayerStrVsBlock(float original) {
		...
		if (this.wearingAccessory(new ItemStack(AetherItems.zanite_pendant))) {
		...
		if (this.getStackInSlot(AccessoryType.RING) != null && this.getStackInSlot(AccessoryType.RING).getItem() == AetherItems.zanite_ring) {
		...
		if (this.getStackInSlot(AccessoryType.EXTRA_RING) != null && this.getStackInSlot(AccessoryType.EXTRA_RING).getItem() == AetherItems.zanite_ring) {
	...
	public void markDirty() {
		if (!this.playerAether.getEntity().worldObj.isRemote && this.playerAether.getEntity() instanceof EntityPlayer) {
			AetherNetwork.sendToAll(new AccessoryPacket(this.playerAether));
		}
	}
	...
	public boolean isItemValidForSlot(int slot, ItemStack stack) {
		if (stack != null && stack.getItem() instanceof Accessory) {
			return ((this.orderedList.func_148745_a(slot) == ((Accessory)stack.getItem()).getType()) || (this.orderedList.func_148745_a(slot) == ((Accessory)stack.getItem()).getExtraType())) && this.getStackInSlot(slot) == null;
		}
	...
	public void setAccessorySlot(AccessoryType type, ItemStack stack) {
		if (stack.getItem() instanceof Accessory) {
			...
			} else if (this.getStackInSlot(((Accessory)stack.getItem()).getExtraType()) == null) {
				this.setAccessorySlot(((Accessory)stack.getItem()).getExtraType(), stack);
			}
		}
	}
	...
	public boolean isWearingZaniteSet() {
		return wearingArmor(new ItemStack(AetherItems.zanite_helmet)) && wearingArmor(new ItemStack(AetherItems.zanite_chestplate)) && wearingArmor(new ItemStack(AetherItems.zanite_leggings)) && wearingArmor(new ItemStack(AetherItems.zanite_boots)) && wearingAccessory(new ItemStack(AetherItems.zanite_gloves));
	}

	@Override
	public boolean isWearingGravititeSet() {
		return wearingArmor(new ItemStack(AetherItems.gravitite_helmet)) && wearingArmor(new ItemStack(AetherItems.gravitite_chestplate)) && wearingArmor(new ItemStack(AetherItems.gravitite_leggings)) && wearingArmor(new ItemStack(AetherItems.gravitite_boots)) && wearingAccessory(new ItemStack(AetherItems.gravitite_gloves));
	}

	@Override
	public boolean isWearingNeptuneSet() {
		return wearingArmor(new ItemStack(AetherItems.neptune_helmet)) && wearingArmor(new ItemStack(AetherItems.neptune_chestplate)) && wearingArmor(new ItemStack(AetherItems.neptune_leggings)) && wearingArmor(new ItemStack(AetherItems.neptune_boots)) && wearingAccessory(new ItemStack(AetherItems.neptune_gloves));
	}

	@Override
	public boolean isWearingPhoenixSet() {
		return wearingArmor(new ItemStack(AetherItems.phoenix_helmet)) && wearingArmor(new ItemStack(AetherItems.phoenix_chestplate)) && wearingArmor(new ItemStack(AetherItems.phoenix_leggings)) && wearingArmor(new ItemStack(AetherItems.phoenix_boots)) && wearingAccessory(new ItemStack(AetherItems.phoenix_gloves));
	}

	@Override
	public boolean isWearingValkyrieSet() {
		return wearingArmor(new ItemStack(AetherItems.valkyrie_helmet)) && wearingArmor(new ItemStack(AetherItems.valkyrie_chestplate)) && wearingArmor(new ItemStack(AetherItems.valkyrie_leggings)) && wearingArmor(new ItemStack(AetherItems.valkyrie_boots)) && wearingAccessory(new ItemStack(AetherItems.valkyrie_gloves));
	}

	@Override
	public boolean isWearingObsidianSet() {
		return wearingArmor(new ItemStack(AetherItems.obsidian_helmet)) && wearingArmor(new ItemStack(AetherItems.obsidian_chestplate)) && wearingArmor(new ItemStack(AetherItems.obsidian_leggings)) && wearingArmor(new ItemStack(AetherItems.obsidian_boots)) && wearingAccessory(new ItemStack(AetherItems.obsidian_gloves));
	}
