...
public class AccessoriesAbility implements IAetherAbility {
	...
	public AccessoriesAbility(IPlayerAether player) {
		this.player = player;
	}
	...
	public void onUpdate() {
		if (this.player.getEntity().ticksExisted % 400 == 0) {
			this.player.getAccessoryInventory().damageWornStack(1, new ItemStack(AetherItems.zanite_ring));
			this.player.getAccessoryInventory().damageWornStack(1, new ItemStack(AetherItems.zanite_pendant));
		}

		if (!this.player.getEntity().worldObj.isRemote && (this.player.getAccessoryInventory().wearingAccessory(new ItemStack(AetherItems.ice_ring)) || this.player.getAccessoryInventory().wearingAccessory(new ItemStack(AetherItems.ice_pendant)))) {
				...
				for (int y = j - 1; y <= j + 1; y++) {
					for (int z = k - 1; z <= k + 1; z++) {
						...
						if (setBlock != null) {
							...
							this.player.getAccessoryInventory().damageWornStack(1, new ItemStack(AetherItems.ice_ring));
							this.player.getAccessoryInventory().damageWornStack(1, new ItemStack(AetherItems.ice_pendant));
						}
					}
				}
			}
		...
		if (this.player.getAccessoryInventory().wearingAccessory(new ItemStack(AetherItems.iron_bubble))) {
		...
		if (this.player.getAccessoryInventory().wearingAccessory(new ItemStack(AetherItems.invisibility_cape))) {
			this.player.getEntity().setInvisible(true);
			this.invisibilityUpdate = true;
		} else if (!this.player.getAccessoryInventory().wearingAccessory(new ItemStack(AetherItems.invisibility_cape)) && !this.player.getEntity().isPotionActive(Potion.invisibility)) {
		...
		if (this.player.getAccessoryInventory().wearingAccessory(new ItemStack(AetherItems.regeneration_stone))) {
		...
		if (this.player.getAccessoryInventory().wearingAccessory(new ItemStack(AetherItems.golden_feather)) || this.player.getAccessoryInventory().wearingAccessory(new ItemStack(AetherItems.valkyrie_cape))) {
			if (!this.player.getEntity().onGround && this.player.getEntity().motionY < 0D && !this.player.getEntity().isInWater() && !this.player.getEntity().isSneaking()) {
