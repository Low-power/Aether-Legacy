...
public class SilverDungeonStructure extends MapGenStructure {

	public SilverDungeonStructure() {
	}
	...
	public static class Start extends StructureStart {
		...
		private void create(World world, Random random, int chunkX, int chunkZ) {
			...
			SilverDungeonComponent dungeon = new SilverDungeonComponent((chunkX << 4) + 2, (chunkZ << 4) + 2);
