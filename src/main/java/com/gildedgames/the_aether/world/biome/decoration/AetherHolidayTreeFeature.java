...
public class AetherHolidayTreeFeature extends WorldGenerator {

	public AetherHolidayTreeFeature() {
		super(true);
	}
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		...
		if(block == AetherBlocks.aether_grass) {
			for (int xss = x - 7; xss < x + 7; xss++) {
				for (int yss = z - 7; yss < z + 7; yss++) {
					if (((xss - x) * (xss - x) + (yss - z) * (yss - z)) < 29) {
						...
						if(rand.nextInt(80) == 0 && (block1 == AetherBlocks.aether_grass)) {
							world.setBlock(x1, y1, z1, AetherBlocks.present);
						} else if(block1 == Blocks.water) {
							world.setBlock(x1, y1 - 1, z1, Blocks.ice);
							world.setBlock(x1, y1, z1, Blocks.snow_layer);
						} else if(world.getBlock(x1, y1, z1) != Blocks.snow_layer || world.getBlock(x1, y1, z1) != AetherBlocks.present) {
							world.setBlock(x1, y1, z1, Blocks.snow_layer);
						}
					}
				}
			...
			for (int y1 = 0; y1 <= 8; y1++) {
				world.setBlock(x, y + y1, z, AetherBlocks.skyroot_log);
			}

			world.setBlock(x, y + 9, z, getBlock(rand));

			world.setBlock(x + 0, y + 2, 1 + z, getBlock(rand));
			world.setBlock(x + 0, y + 2, 2 + z, AetherBlocks.skyroot_log);
			...
			world.setBlock(x + -1, y + 2, 0 + z, getBlock(rand));
			world.setBlock(x + -2, y + 2, 0 + z, getBlock(rand));
			world.setBlock(x + -3, y + 2, 0 + z, AetherBlocks.skyroot_log);
			world.setBlock(x + -4, y + 2, 0 + z, getBlock(rand));
			...
			world.setBlock(x + -1, y + 2, 1 + z, getBlock(rand));
			world.setBlock(x + -1, y + 2, 2 + z, AetherBlocks.skyroot_log);
			world.setBlock(x + -1, y + 2, 3 + z, getBlock(rand));
			world.setBlock(x + -1, y + 2, 4 + z, getBlock(rand));
			world.setBlock(x + 1, y + 2, -1 + z, getBlock(rand));
			world.setBlock(x + 1, y + 2, -2 + z, getBlock(rand));
			...
			world.setBlock(x + -1, y + 5, 1 + z, AetherBlocks.skyroot_log);
			world.setBlock(x + -1, y + 5, 2 + z, getBlock(rand));
			world.setBlock(x + 1, y + 5, -1 + z, getBlock(rand));
			world.setBlock(x + 1, y + 5, -2 + z, getBlock(rand));
			world.setBlock(x + -1, y + 5, -1 + z, getBlock(rand));
			...
			world.setBlock(x + 2, y + 5, -1 + z, getBlock(rand));
			world.setBlock(x + -1, y + 5, 1 + z, getBlock(rand));
			world.setBlock(x + -2, y + 5, 1 + z, AetherBlocks.skyroot_log);
			world.setBlock(x + -1, y + 5, -1 + z, getBlock(rand));
			world.setBlock(x + -2, y + 5, -1 + z, getBlock(rand));
			...
			world.setBlock(x, y - 1, z, AetherBlocks.aether_dirt);
			...
			for (int xss = x - 7; xss < x + 7; xss++) {
				for (int yss = z - 7; yss < z + 7; yss++) {
					if (((xss - x) * (xss - x) + (yss - z) * (yss - z)) < 29) {
						...
						if(rand.nextInt(40) == 0 && (block1 == AetherBlocks.aether_grass)) {
							world.setBlock(x1, y1, z1, AetherBlocks.present);
						} else if(block1 == Blocks.water) {
							world.setBlock(x1, y1 - 1, z1, Blocks.ice);
							world.setBlock(x1, y1, z1, Blocks.snow_layer);
	...
	public Block getBlock(Random rand) {
		return rand.nextInt(4) == 0 ? AetherBlocks.decorated_holiday_leaves : AetherBlocks.holiday_leaves;
	}
}
