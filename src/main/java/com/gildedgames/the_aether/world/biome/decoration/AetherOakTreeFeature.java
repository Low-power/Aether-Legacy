...
public class AetherOakTreeFeature extends WorldGenAbstractTree {

	public AetherOakTreeFeature() {
		super(true);
	}
	...
	public boolean generate(World world, Random random, int x, int y, int z) {
		if(world.getBlock(x, y - 1, z) != AetherBlocks.aether_grass && world.getBlock(x, y - 1, z) != AetherBlocks.aether_dirt) {
			return false;
		}
