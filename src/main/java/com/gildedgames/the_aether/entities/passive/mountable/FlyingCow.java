...
public class FlyingCow extends EntitySaddleMount {
	...
	public FlyingCow(World world) {
		...
		this.tasks.addTask(1, new EntityAIPanic(this, 2D));
	...
	protected void func_145780_a(int x, int y, int z, Block block) {
		this.playSound("mob.cow.step", 0.15F, 1F);
	}

	@Override
	public EntityAgeable createChild(EntityAgeable entity) {
		return new FlyingCow(this.worldObj);
	}
