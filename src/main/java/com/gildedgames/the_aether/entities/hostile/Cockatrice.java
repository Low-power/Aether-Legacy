...
// Super class: bad MCP name: should be 'HostileMob'
public class Cockatrice extends EntityMob {

	public float wingRotation, destPos, prevDestPos, prevWingRotation;

	public int shootTime, ticksUntilFlap;

	public Cockatrice(World world) {
		super(world);

		this.stepHeight = 1F;
		this.setSize(1F, 2F);
		this.tasks.addTask(0, new EntityAISwimming(this));
		this.tasks.addTask(2, new EntityAIMoveTowardsTarget(this, 1D, 8F));
	...
	public void onUpdate() {
		...
		if (this.getEntityToAttack() != null) {
			...
			this.getLookHelper().setLookPositionWithEntity(this.getEntityToAttack(), 30F, 30F);
	...
	public void shootTarget() {
		...
		EntityArrow entityarrow = new PoisonNeedleEntity(this.worldObj, this, 1F);
		this.playSound("random.bow", 1F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
	...
	public void updateWingRotation() {
		...
		this.destPos += 0.2D;
		this.destPos = Moa.minMax(0.01F, 1F, this.destPos);
