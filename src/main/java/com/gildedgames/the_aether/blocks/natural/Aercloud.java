...
public class Aercloud extends Block implements IColoredBlock, INamedBlock {
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		...
		if (world.getBlockMetadata(x, y, z) == 1) {
			if (entity instanceof EntityPlayer) {
				...
				player.triggerAchievement(AetherAchievements.blue_cloud);
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World world, int x, int y, int z) {
		return world.getBlockMetadata(x, y, z) != 1 ? AxisAlignedBB.getBoundingBox(x, y, z, x + 1D, y + 0.01D, z + 1D) : AxisAlignedBB.getBoundingBox(x, y, z, x, y, z);
	}
