...
public class DungeonBaseBlock extends Block {

	private Block pickBlock;

	private boolean isLit;

	public DungeonBaseBlock(boolean isLit) {
		this(null, isLit);
	}

	public DungeonBaseBlock(Block pickBlock, boolean isLit) {
		super(Material.rock);
