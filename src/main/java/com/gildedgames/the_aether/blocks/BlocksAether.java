...
public class BlocksAether {
	...
	public static void initialization() {
		...
		aether_dirt = registerMeta("aether_dirt", new AetherDirt());
		holystone = registerMeta("holystone", new Holystone());
		mossy_holystone = registerMeta("mossy_holystone", new Holystone().setBlockTextureName(Aether.find("mossy_holystone")));
		...
		quicksoil = registerMeta("quicksoil", new Quicksoil());
