...
public class AetherArmor extends ItemArmor {
	...
	public AetherArmor(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public AetherArmor(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
	...
	public EnumRarity getRarity(ItemStack stack) {
		return !this.armorName.contains("zanite") && !this.armorName.contains("gravitite") ? AetherItems.aether_loot : super.getRarity(stack);
	}
}
