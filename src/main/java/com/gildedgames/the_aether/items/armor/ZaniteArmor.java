...
public class ZaniteArmor extends AetherArmor implements ISpecialArmor {
	...
	public ZaniteArmor(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
