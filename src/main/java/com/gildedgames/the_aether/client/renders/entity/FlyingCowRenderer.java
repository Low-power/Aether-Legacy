...
public class FlyingCowRenderer extends RenderLiving {
	...
	public FlyingCowRenderer() {
		super(new FlyingCowModel(0F), 0.7F);
	}

	protected int renderLayers(FlyingCow entity, int pass, float particleTicks) {
	...
	protected int shouldRenderPass(EntityLivingBase entity, int pass, float particleTicks) {
		return this.renderLayers((FlyingCow)entity, pass, particleTicks);
	}
