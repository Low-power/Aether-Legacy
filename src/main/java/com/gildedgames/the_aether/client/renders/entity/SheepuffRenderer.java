...
public class SheepuffRenderer extends RenderLiving {
	...
	protected int renderLayer(Sheepuff entity, int pass, float particleTicks) {
		if (entity.isInvisible()) {
			...
			if (entity.hasCustomNameTag() && entity.getCustomNameTag().equals("jeb_")) {
				...
				float f1 = ((float) (entity.ticksExisted % 25) + particleTicks) / 25F;
				GL11.glColor3f(EntitySheep.fleeceColorTable[l][0] * (1F - f1) + EntitySheep.fleeceColorTable[i1][0] * f1, EntitySheep.fleeceColorTable[l][1] * (1F - f1) + EntitySheep.fleeceColorTable[i1][1] * f1, EntitySheep.fleeceColorTable[l][2] * (1F - f1) + EntitySheep.fleeceColorTable[i1][2] * f1);
			} else {
	...
	protected int shouldRenderPass(EntityLivingBase entity, int pass, float particleTicks) {
		return this.renderLayer((Sheepuff)entity, pass, particleTicks);
	}
