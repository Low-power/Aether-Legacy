...
public class AetherPerksGui extends GuiScreen {
	...
	public AetherPerksGui() {
		super();

		this.mc = Minecraft.getMinecraft();
		this.player = PlayerAether.get(this.mc.thePlayer);
		this.moaSkin = this.player.donatorMoaSkin;
		Entity riding_entity = this.player.getEntity().ridingEntity;
		this.moa = riding_entity instanceof Moa ? (Moa)riding_entity : new Moa(this.mc.theWorld, AetherMoaTypes.blue);
	}
