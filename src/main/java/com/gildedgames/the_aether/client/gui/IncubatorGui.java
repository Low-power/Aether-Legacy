...
public class IncubatorGui extends GuiContainer {
	...
	private IncubatorTileEntity incubatorInventory;

	private static final ResourceLocation TEXTURE_INCUBATOR = Aether.locate("textures/gui/incubator.png");

	public IncubatorGui(EntityPlayer player, InventoryPlayer inventoryplayer, IncubatorTileEntity tileentityIncubator) {
		super(new IncubatorContainer(player, inventoryplayer, tileentityIncubator));

		this.incubatorInventory = (IncubatorTileEntity)tileentityIncubator;
	}
