...
public class AetherRegistries {
	...
	private static void initializeRecipes() {
		...
		register("skyroot_stick", new ItemStack(AetherItems.skyroot_stick, 4), "X", "X", 'X', BlocksAether.skyroot_planks);
		...
		register("zanite_block", new ItemStack(BlocksAether.zanite_block), "XXX", "XXX", "XXX", 'X', AetherItems.zanite_gemstone);
		register("zanite_gemstone", new ItemStack(AetherItems.zanite_gemstone, 9), "X", 'X', BlocksAether.zanite_block);
		register("golden_dart_shooter", new ItemStack(AetherItems.dart_shooter, 1), "X  ", " Y ", "  Y", 'X', AetherItems.golden_amber, 'Y', BlocksAether.skyroot_planks);
		...
		register("enchanter", new ItemStack(BlocksAether.enchanter), "XXX", "XYX", "XXX", 'X', BlocksAether.holystone, 'Y', AetherItems.zanite_gemstone);
		...
		register("sign", new ItemStack(Items.sign, 3), "XXX", "XXX", " Y ", 'X', BlocksAether.skyroot_planks, 'Y', AetherItems.skyroot_stick);
		register("ambrosium_torch", new ItemStack(BlocksAether.ambrosium_torch, 2), "Z", "Y", 'Z', AetherItems.ambrosium_shard, 'Y', AetherItems.skyroot_stick);
		register("lead", new ItemStack(Items.lead, 2), "YY ", "YX ", "  Y", 'Y', Items.string, 'X', AetherItems.swet_ball);

		register("cloud_parachute", new ItemStack(AetherItems.cloud_parachute, 1), "XX", "XX", 'X', new ItemStack(BlocksAether.aercloud, 1));
		register("golden_parachute", new ItemStack(AetherItems.golden_parachute, 1), "XX", "XX", 'X', new ItemStack(BlocksAether.aercloud, 1, 2));
		...
		register("skyroot_bucket", new ItemStack(AetherItems.skyroot_bucket, 1, 0), "Z Z", " Z ", 'Z', BlocksAether.skyroot_planks);
		register("crafting_table", new ItemStack(Blocks.crafting_table, 1), "XX", "XX", 'X', BlocksAether.skyroot_planks);

		register("gravitite_helmet", new ItemStack(AetherItems.gravitite_helmet, 1), "XXX", "X X", 'X', BlocksAether.enchanted_gravitite);
		register("gravitite_chestplate", new ItemStack(AetherItems.gravitite_chestplate, 1), "X X", "XXX", "XXX", 'X', BlocksAether.enchanted_gravitite);
		register("gravitite_leggings", new ItemStack(AetherItems.gravitite_leggings, 1), "XXX", "X X", "X X", 'X', BlocksAether.enchanted_gravitite);
		register("gravitite_boots", new ItemStack(AetherItems.gravitite_boots, 1), "X X", "X X", 'X', BlocksAether.enchanted_gravitite);
		...
		register("skyroot_pickaxe", new ItemStack(AetherItems.skyroot_pickaxe, 1), "ZZZ", " Y ", " Y ", 'Z', BlocksAether.skyroot_planks, 'Y', AetherItems.skyroot_stick);
		register("holystone_pickaxe", new ItemStack(AetherItems.holystone_pickaxe, 1), "ZZZ", " Y ", " Y ", 'Z', BlocksAether.holystone, 'Y', AetherItems.skyroot_stick);
		...
		register("gravitite_pickaxe", new ItemStack(AetherItems.gravitite_pickaxe, 1), "ZZZ", " Y ", " Y ", 'Z', BlocksAether.enchanted_gravitite, 'Y', AetherItems.skyroot_stick);
		register("skyroot_axe", new ItemStack(AetherItems.skyroot_axe, 1), "ZZ", "ZY", " Y", 'Z', BlocksAether.skyroot_planks, 'Y', AetherItems.skyroot_stick);
		register("holystone_axe", new ItemStack(AetherItems.holystone_axe, 1), "ZZ", "ZY", " Y", 'Z', BlocksAether.holystone, 'Y', AetherItems.skyroot_stick);
		...
		register("gravitite_axe", new ItemStack(AetherItems.gravitite_axe, 1), "ZZ", "ZY", " Y", 'Z', BlocksAether.enchanted_gravitite, 'Y', AetherItems.skyroot_stick);
		register("skyroot_shovel", new ItemStack(AetherItems.skyroot_shovel, 1), "Z", "Y", "Y", 'Z', BlocksAether.skyroot_planks, 'Y', AetherItems.skyroot_stick);
		register("holystone_shovel", new ItemStack(AetherItems.holystone_shovel, 1), "Z", "Y", "Y", 'Z', BlocksAether.holystone, 'Y', AetherItems.skyroot_stick);
		...
		register("gravitite_shovel", new ItemStack(AetherItems.gravitite_shovel, 1), "Z", "Y", "Y", 'Z', BlocksAether.enchanted_gravitite, 'Y', AetherItems.skyroot_stick);
		register("skyroot_sword", new ItemStack(AetherItems.skyroot_sword, 1), "Z", "Z", "Y", 'Z', BlocksAether.skyroot_planks, 'Y', AetherItems.skyroot_stick);
		register("holystone_sword", new ItemStack(AetherItems.holystone_sword, 1), "Z", "Z", "Y", 'Z', BlocksAether.holystone, 'Y', AetherItems.skyroot_stick);
		...
		register("gravitite_sword", new ItemStack(AetherItems.gravitite_sword, 1), "Z", "Z", "Y", 'Z', BlocksAether.enchanted_gravitite, 'Y', AetherItems.skyroot_stick);
		...
		register("gravitite_gloves", new ItemStack(AetherItems.gravitite_gloves), "C C", 'C', BlocksAether.enchanted_gravitite);

		register("skyroot_fence", new ItemStack(BlocksAether.skyroot_fence, 3), "ZXZ", "ZXZ", 'Z', new ItemStack(BlocksAether.skyroot_planks), 'X', new ItemStack(AetherItems.skyroot_stick));
		register("skyroot_fence_gate", new ItemStack(BlocksAether.skyroot_fence_gate), "ZXZ", "ZXZ", 'X', new ItemStack(BlocksAether.skyroot_planks), 'Z', new ItemStack(AetherItems.skyroot_stick));
		...
		register("skyroot_bed_item", new ItemStack(AetherItems.skyroot_bed_item, 1),  "XXX", "ZZZ", 'Z', new ItemStack(BlocksAether.skyroot_planks), 'X', Blocks.wool);
	}
