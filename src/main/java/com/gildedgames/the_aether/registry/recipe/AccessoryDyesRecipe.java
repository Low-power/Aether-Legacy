...
public class AccessoryDyesRecipe implements IRecipe {
	...
	public boolean matches(InventoryCrafting p_77569_1_, World p_77569_2_) {
		...
		for (int i = 0; i < p_77569_1_.getSizeInventory(); ++i) {
			...
			if (itemstack1 != null) {
				if (itemstack1.getItem() instanceof DyedAccessory) {
					if (itemstack != null) {
						return false;
					}
...
//			if (itemstack1 != null) {
//				if (itemstack1.getItem() instanceof DyedAccessory) {
//					itemarmor = (DyedAccessory)itemstack1.getItem();
//
//					if (itemstack != null) {
//						return null;
//					}
...
//					f = (float) (l >> 16 & 255) / 255F;
//					f1 = (float) (l >> 8 & 255) / 255F;
...
//	}
	...
	public ItemStack getCraftingResult(InventoryCrafting p_77572_1_) {
		...
		for (k = 0; k < p_77572_1_.getSizeInventory(); ++k) {
			...
			if (itemstack1 != null) {
				if (itemstack1.getItem() instanceof DyedAccessory) {
					accessory = (DyedAccessory)itemstack1.getItem();
					...
					if (accessory.hasColor(itemstack1)) {
						l = accessory.getColor(itemstack);
						f = (float)(l >> 16 & 255) / 255F;
						f1 = (float)(l >> 8 & 255) / 255F;
						float f2 = (float)(l & 255) / 255F;
						i = (int)((float)i + Math.max(f, Math.max(f1, f2)) * 255F);
		...
		l1 = (k << 8) + i1;
		l1 = (l1 << 8) + l;
		accessory.setColorTag(itemstack, l1);
		return itemstack;
	}
